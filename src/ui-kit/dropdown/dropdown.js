...
$(function () {
	$('.dropdown__container').on('click', function (event) {

		if(event.target.closest('.dropdown__container-title')){
			$('.dropdown__container').toggleClass('dropdown__container_show');
		}
	...
	function clear() {
		...
		$('.dropdown-item__sub-button').removeClass('dropdown-item__sub-button_active')
	}
